...
if (isEngineOn _vehicle) exitWith {["Turn off the engine before unloading crates."] call DT_fnc_notify};
...
_vehicle setVariable ["DT_loadedCrates",nil,true];
_vehicle allowDamage true;
["Vehicle unloaded."] call DT_fnc_notify;