...
*/
private _markerSetting = getNumber(missionConfigFile >> "Settings" >> "bluforMapMarkers");
if (_markerSetting < 0) exitWith {};
private _markers = [];
